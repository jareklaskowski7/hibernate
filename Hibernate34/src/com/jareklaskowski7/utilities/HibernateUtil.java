    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                //Missing cache[com.jareklaskowski7.dto.User] was created on-the-fly. The created cache will use a provider-specific default configuration: make sure you defined one.
                // You can disable this warning by setting 'hibernate.cache.ehcache.missing_cache_strategy' to 'create'.
                hibernateProperties.put("hibernate.cache.ehcache.missing_cache_strategy", "create");
                hibernateProperties.put("hibernate.cache.region.factory_class", "org.hibernate.cache.ehcache.internal.EhcacheRegionFactory");
