    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                hibernateProperties.put("hibernate.hbm2ddl.auto", "create");  // "update"
                ...
                MetadataSources metadataSources = new MetadataSources(stdSerRegistry).addAnnotatedClass(User.class);
